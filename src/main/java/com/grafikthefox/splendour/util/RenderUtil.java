...
import com.grafikthefox.splendour.SplendourClient;
...
public class RenderUtil {
    ...
    public static RenderType GLOWING_PARTICLE = RenderType.create(
            Splendour.MOD_ID + ":glowing_particle",
            ...
            RenderType.CompositeState.builder()
                    ...
                    .setShaderState(new RenderStateShard.ShaderStateShard(SplendourClient::getGlowingParticleShader))
                    .createCompositeState(false));

    public static RenderType DELAYED_PARTICLE = RenderType.create(
            Splendour.MOD_ID + ":delayed_particle",
            DefaultVertexFormat.PARTICLE,
            VertexFormat.Mode.QUADS, 256, true, false,
            RenderType.CompositeState.builder()
                    .setWriteMaskState(new RenderStateShard.WriteMaskStateShard(true, false))
                    ...
                    .setTextureState(new RenderStateShard.TextureStateShard(TextureAtlas.LOCATION_PARTICLES, false, false))
                    .setShaderState(new RenderStateShard.ShaderStateShard(SplendourClient::getSpriteParticleShader))
                    .createCompositeState(false));
