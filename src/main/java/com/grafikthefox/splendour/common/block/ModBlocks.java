...
import com.grafikthefox.splendour.common.block.custom.*;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> DEVOIDED_GRASS_BLOCK = registerBlock("devoided_grass_block",
            () -> new DevoidedGrassBlock(BlockBehaviour.Properties.copy(Blocks.GRASS_BLOCK).strength(1.2F).mapColor(MapColor.TERRACOTTA_PURPLE)));
    ...
    public static final RegistryObject<Block> FADED_PLANKS = registerBlock("faded_planks",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).strength(2.5F)));
    ...
    public static final RegistryObject<Block> POTTED_VOID_FUNGUS = BLOCKS.register("potted_void_fungus",
            () -> new FlowerPotBlock(VOID_FUNGUS.get(), BlockBehaviour.Properties.copy(Blocks.FLOWER_POT).instabreak().noOcclusion()));

    public static final RegistryObject<Block> WALL_FUNGI = registerBlock("wall_fungi",
            () -> new WallFungiBlock(BlockBehaviour.Properties.copy(Blocks.RED_MUSHROOM).mapColor(MapColor.TERRACOTTA_MAGENTA)));

    public static final RegistryObject<Block> VOID_FUNGUS_BLOCK = registerBlock("void_fungus_block",
            () -> new HugeMushroomBlock(BlockBehaviour.Properties.copy(Blocks.RED_MUSHROOM_BLOCK).mapColor(MapColor.TERRACOTTA_MAGENTA)));

    public static final RegistryObject<Block> VOID_FUNGUS_STEM = registerBlock("void_fungus_stem",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.RED_MUSHROOM_BLOCK).mapColor(MapColor.TERRACOTTA_MAGENTA)));
    ...
    public static final RegistryObject<Block> MOONLIGHT_MOTH_HIVE = registerBlock("moonlight_moth_hive",
            () -> new MoonlightMothHiveBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).strength(2.5F)));
    ...
    public static final RegistryObject<Block> CELESTIAL_STONE = registerBlock("celestial_stone",
    ...
    public static final RegistryObject<Block> CELESTIAL_PEDESTAL = registerBlock("celestial_pedestal",
            () -> new CelestialPedestalBlock(BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_GRAY).noOcclusion()));
    public static final RegistryObject<Block> GLOBE_STAND = registerBlock("globe_stand",
            () -> new GlobeStandBlock(BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_GRAY).noOcclusion()));
